...
from iflow.model.nn import made as made_module
from iflow.model.flows import splines

from iflow.utils import math as utils
...
class AutoregressiveTransform(nn.Module):
    ...
    def forward(self, x, logpx=None, reverse=False, context=None):
        ...
        if not reverse:
            ...
            y, delta_logp = self._elementwise_forward(x, autoregressive_params)
        else:
            ...
            for _ in range(num_inputs):
                ...
                y, delta_logp = self._elementwise_inverse(x, autoregressive_params)
        if logpx is None:
            return y
        else:
